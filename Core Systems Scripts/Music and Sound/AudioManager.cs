...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] AudioClip pickupXPSFX;
    [SerializeField] AudioClip pickupGoldSFX;

    [SerializeField] AudioClip castWandSFX;
    [SerializeField] AudioClip wandHitSFX;
    [SerializeField] AudioClip castGarlicSFX;
    ...
    public void PlayCastWandSFX()
    {
        PlaySoundEffect(castWandSFX);
    }
    public void PlayWandHitSFX()
    {
        PlaySoundEffect(wandHitSFX);
    }
    public void PlayCastGarlicSFX()
    {
        PlaySoundEffect(castGarlicSFX);
    }
    ...
    public void PlayPickupXPSFX()
    {
        PlaySoundEffect(pickupXPSFX);
    }
    public void PlayPickupGoldSFX()
    {
        PlaySoundEffect(pickupGoldSFX);
    }
